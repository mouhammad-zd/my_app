var g_current_page = "";
var g_web_link = "http://192.168.0.99/cyberaman/local/";
var g_current_program = "cybernews";
var g_language = "Arabic";
var g_api_link = "http://192.168.0.99/cyberaman/local/programs/api/api_full.php";
var g_token = "";
var g_uuid = "";
var g_last_news = '1';
...
var g_user = {c : "",co : "",e : "",f : "",i : "","n" : "","p" : "","pt" : ""};
document.addEventListener('deviceready',initialize_application, false);
...
function bind_system_events()
    {
        ...
        $(document).ready(ev_document_ready);
        $.ui.ready(ev_afui_ready);
    }
